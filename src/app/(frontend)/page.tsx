            ...
            <div className="hero-top">
              <div>
                ...
                <div className="hero-actions">
                  <a className="btn btn-primary arrow" href="#projets">Voir mes projets</a>
                  <a className="btn btn-outline" href={site.cvUrl} target="_blank" rel="noopener">Télécharger mon CV</a>
                </div>
              </div>
              {heroImg && (
