...
export const Hero: GlobalConfig = {
  ...
  fields: [
    { name: "folioLabel", type: "text", localized: true, required: true, defaultValue: "Portfolio · Ingénieur Structures" },
    ...
    { name: "imageAlt", type: "text", localized: true, label: "Texte alternatif" },
    { name: "imageCaption", type: "text", localized: true, label: "Légende" },
    { name: "imageYear", type: "text", label: "Année", defaultValue: "2024" },
    { name: "availability", type: "text", localized: true, required: true, label: "Statut de disponibilité", defaultValue: "Disponible — stage 4 à 6 mois" },
    { name: "location", type: "text", localized: true, required: true, defaultValue: "Dakar, Sénégal" },
    { name: "domain", type: "text", localized: true, required: true, defaultValue: "Béton armé · Charpente métallique · Dynamique" },
  ],
};
